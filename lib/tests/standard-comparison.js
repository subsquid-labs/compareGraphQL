...
export function standardComparison(
   ...
   */
	...
	console.log(`Comparing ${referenceEntities.length} entities of the reference API to ${sampleEntities.length} entities of the sample API`)
	...
	const {
		...
		nonTemporalReferenceEntitiesNames,
		{ entities: referenceEntities, apiUrl: referenceApiUrl, kind: referenceKind },
		{ entities: sampleEntities, apiUrl: sampleApiUrl, kind: sampleKind },
